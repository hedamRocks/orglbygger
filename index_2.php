	...
	<body class="black">
        ...
        <div id="mobileHeader" class="big-pad mobileOn">
            ...
            <div id="mobileMenu" class="white-text plain-col-right big-pad" style="display:none;">
                ...
                <div class="menu-item plain-col big-pad full-width" onClick="Ajax('referencer.php','main-content');closeMenu();">KONTAKT</div>

                <div class="plain-col"><h3 class="lighter-text">Links</h3></div>

                <div class="menu-item plain-col big-pad full-width" onclick="window.open('http://www.sarastro.dk/orgel.htm','_blank');">
                    <img class="link-box-icon" src="assets/img/icons/history_icon.png" style="height:30px;">
                    <div>Orglets historie</div>
                </div>
                <div class="menu-item plain-col big-pad full-width" onClick="Ajax('saadanVirkerOrglet.php','main-content');closeMenu();">
                    <img class="link-box-icon" src="assets/img/icons/organ_icon.png" style="height:30px;">
                    <div>Sådan virker orglet</div>
                </div>
                <div class="menu-item plain-col big-pad full-width" onClick="Ajax('enAegteOrgelGyser.php','main-content');closeMenu();">
                    <img class="link-box-icon" src="assets/img/icons/ghost_icon.png" style="height:30px;">
                    <div>En ægte orgelgyser</div>
                </div>
                <div class="menu-item plain-col big-pad full-width" onClick="Ajax('snittegninger.php','main-content');closeMenu();">
                    <img class="link-box-icon" src="assets/img/icons/draw_icon.png" style="height:30px;">
                    <div>Snittegninger</div>
                </div>
<!--
            ...
            <div id="content" class="content-container">
                ...
                <div class="content-container-inner">
                    <div class="container-fluid">
                        <div class="row" style="margin: -140px 0px 50px 0px;display:none;">
                            <div class="col-sm-3">
